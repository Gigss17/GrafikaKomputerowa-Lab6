...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {
		...
		int n = 4; //Iloœæ boków 
		int color=5; //Pozwala zmieniæ kolor
		int size =12;
		...
		gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[color][12] ); //W tej konfiguracji piramida bêdzie przechodzi³a w kolor jasnoró¿owy
